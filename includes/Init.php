...
final class Init
{
    ...
    public function u_payments_gateway_start()
    {
        ...
        include_once BD_PAYMENT_GATEWAYS_DIR_PATH . 'includes/Gateways/bKash.php';
        include_once BD_PAYMENT_GATEWAYS_DIR_PATH . 'includes/Gateways/Rocket.php';
        include_once BD_PAYMENT_GATEWAYS_DIR_PATH . 'includes/Gateways/Nagad.php';
    }
